...
const Placeorder = () => {
  const [method , setMedthod] = useState('cod');
      ...
      <div className=' mt-8'>
        ...
        <div className=' mt-12'>
          ...
          <div className=' flex gap-3 flex-col lg:flex-row'>
            <div onClick={()=>setMedthod('stripe')} className=' flex items-center gap-3 border p-2 px-3 cursor-pointer'>
            ...
            <div onClick={()=>setMedthod('razorpay')}className=' flex items-center gap-3 border p-2 px-3 cursor-pointer'>
            ...
            <div  onClick={()=>setMedthod('cod')} className=' flex items-center gap-3 border p-2 px-3 cursor-pointer'>
